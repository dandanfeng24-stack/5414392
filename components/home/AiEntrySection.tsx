  ...
  return (
    <section className="border-y border-paper/10 py-20">
      <div className="section-shell grid gap-8 md:grid-cols-[0.9fr_1.1fr]">
        <div>
          <div className="text-sm text-gold">智能初评</div>
          ...
          <p className="mt-5 text-base leading-8 text-linen">
            输入地区、项目类型、客群、预算、目标和本地文化资源，系统基于转化规则生成适配度、推荐方向、风险提示和资料包建议。
          </p>
          <Link href="/ai-assessment" className="mt-8 inline-flex rounded bg-gold px-6 py-3 text-sm text-ink hover:bg-paper">开始智能初评</Link>
        </div>
